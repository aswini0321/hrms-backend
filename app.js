...
//         return {
//           'Mandal Name': obj.mandalName,
//           'Secretariat Name & Code': obj.secretariatNameCode,
//           'Employee Name': obj.employeeName,
//           'Employee ID': obj.employeeId,
//           'Designation': obj.designation,
//           'Probation': obj.probation,
//           'PS/VRO Grade': obj.psVroGrade,
//           'Date of Birth': obj.dob,
//           'Date of Joining': obj.doj,
//           'HRMS ID': obj.hrmsId,
//           'CFMS ID': obj.cfmsId,
//           'Email ID': obj.emailId,
//           'Mobile Number': obj.mobileNumber,
//           'Aadhaar Number': obj.aadhaarNumber,
//           'Rationalization Position': obj.rationalizationPosition,
//           'Last Updated Date': obj.lastUpdatedDate,
//           'Transferred Recently': obj.transferredRecently,
//           'Salary Drawing Present': obj.salaryDrawingPresent,
//           'Salary Drawing Office': obj.salaryDrawingOffice,
//           'Employment Type': obj.employmentType,
//           'Deputation Location': obj.deputationLocation,
//           'Remarks': obj.remarks
//         };
//       }
//        else if (category === 'b') {
...
app.get('/export/:category', async (req, res) => {
  const { category } = req.params;
  if (category !== 'a') return res.status(400).json({ success: false, message: 'Invalid category' });

  const categoryAData = await CategoryA.find();

  const data = categoryAData.map(obj => ({
    'Mandal Name': obj.mandalName || '',
    'Secretariat Name & Code': obj.secretariatNameCode || '',
    'Employee Name': obj.employeeName || '',
    'Employee ID': obj.employeeId || '',
  ...
  const xls = json2xls(data);
  res.setHeader('Content-Type', 'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet');
  res.setHeader('Content-Disposition', 'attachment; filename=categoryA_data.xlsx');
  res.end(xls, 'binary');
});
